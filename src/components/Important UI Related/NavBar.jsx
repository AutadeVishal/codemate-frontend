...
const NavBar = () => {
  ...
  className="text-3xl font-extrabold tracking-wide 
             ...
             shadow-lg 
             hover:scale-105 hover:border-white/60 hover:shadow-white/30
...
{user && (
  <div className="relative flex items-center gap-3">
    ...
    {/* Dropdown Menu */}
    {menuOpen && (
      <ul className="absolute right-0 top-14 w-56 bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl shadow-xl p-3 text-sm text-white animate-fadeIn">
        <li className="mb-2">
          <Link
            to="/profile"
